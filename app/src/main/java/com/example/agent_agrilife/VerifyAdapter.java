...
public class VerifyAdapter extends RecyclerView.Adapter<VerifyAdapter.MyViewHolder>
{
    ...
    public VerifyAdapter(Context context, ArrayList<FarmUser> userList)
    {
    ...
    @NonNull
    @Override
    public VerifyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.card_view,parent,false);
        return new VerifyAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull VerifyAdapter.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent ApproveRejectWindow = new Intent(context , ApproveRejectVerify.class);
